...
slug: "stove-lake-to-fairbrother-corner"
myhikeid: "020"
layout: "hikesimple"
trailhead: 'stovelake'
length: 'gt10km'
categories:
 - "Stove Lake Trailhead Gate"
    ...
    <h4 class="text-xl font-large mt-4">Hike Details</h4>
      ...
      <tbody>
        <tr>
          ...
          <td valign="top" style="padding-left: 10px;" class="my-4 text-base"><a href="/trailheads/stove-lake/" target="_blank">Stove Lake Trailhead Gate</a></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td valign="top" style="padding-left: 10px;" class="text-base">{{< getdiffrating cur=189 >}}</td>
        </tr>
        <tr>
