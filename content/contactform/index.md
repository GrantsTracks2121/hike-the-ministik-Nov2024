...
<section class="bg-white dark:bg-gray-900">
  ...
  <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Your email</label>
          ...
          </br>You must click the box below to ensure your message is sent.</br>
          <div data-netlify-recaptcha="true"></div>
          <button type="submit" class="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 dark:text-white" style="color: white">Send message</button>
      </form>
  </div>
</section>
