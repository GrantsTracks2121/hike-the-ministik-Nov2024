...
<script>
  function onSubmit(event) {
    ...
    grecaptcha.ready(function() {
      // It's good practice to make sure the site key here matches the render key
      grecaptcha.execute('6LfhI10rAAAAAPjMj_r7RycX5lBBzy3n08XckxJI', {action: 'submit'}).then(function(token) {
        ...
        // Now submit your form programmatically
        document.getElementById("HikeTheMinistik-contact-form").submit();
      });
    });
  }
</script>
